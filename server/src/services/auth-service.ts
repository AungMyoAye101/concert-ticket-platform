...
import { InternalServerError, UnauthorizedError } from "../common/errors/http-errors";
...
export const loginUser = async (email: string, password: string) => {
    ...
    const token = jwt.sign({ sub: user.id, email: user.email } satisfies AuthTokenPayload, getJwtSecret(), { expiresIn: JWT_EXPIRES_IN } as SignOptions);
